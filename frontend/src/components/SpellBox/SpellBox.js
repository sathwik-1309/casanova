...
function SpellBox(props) {
    const p = props.data
    return (
        <div onClick={() => props.func(p)} className={`spellbox ${p.tour}`}>
            <div className={`spellbox_pic ${p.color}1`}>
                <Photocard p_id = {p.p_id} height={'85px'}/>
            </div>
            <div className='spellbox_info'>
                ...
                <div className={`spellbox_body ${p.color}1`}>
                    <div className={`spellbox_labels`}>
