...
import TeamWinPercentage from '../../Team/TeamWinPercentage/TeamWinPercentage';

function SquadBox(props) {
    let data = props.data
    const meta = {
        color: data.color
    }
    ...
    return (
        <Link className= 'teambox_parent' to={`${FRONTEND_API_URL}/tournament/${props.t_id}/squads/${data.id}`}>
